...
describe Api::V2::PublishersController, fake_name: true do
  ...
  let!(:valid_headers2)     { generate_headers(user2, application) }
  let!(:valid_headers3)     { generate_headers(user3, application) }
